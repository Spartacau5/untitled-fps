...
export const DEFAULTS = {
  ...
  // Aiming gets its own again - tracking a target and placing a crosshair
  // want different speeds, and most players tune them apart.
  padSensitivity: 1,
  padAdsSensitivity: 0.8,
  fov: 80,
  master: 0.9,
  music: 1,
  sfx: 1,
...
export const RANGES = {
  ...
  padAdsSensitivity: { min: 0.2, max: 3, step: 0.1 },
