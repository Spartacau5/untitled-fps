...
This branch adds [the v6 fidelity foundation](docs/MIDTOWN-V6.md): scanned surface materials, damp afternoon lighting, storefront depth, rooftop detail and original Broadway artwork. See [the Gun Game notes](docs/MIDTOWN-GUN-GAME.md) for gameplay rules. The procedural operators and synthesized audio are interim assets, not final TTK-level art or recordings.
...
- `?perf` - local FPS, P95 frame interval and render-count overlay
